...
class TelegramBot:
    ...
    def send_message(self, chat_id: str, name: str, model: str, price: str, link: str) -> Message:
        message = """
        📣 *{0}*
        📃 Model: *{1}* 
        💰 Price: *{2}* 
    ...
    def edit_message(self, chat_id: str, message_id: str, name: str, model: str, price: str, link: str):
        message = """
        ❌ EXPIRED ❌
        📣 *{0}*
        📃 Model: *{1}* 
